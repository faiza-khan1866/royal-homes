...
const Sidebar = ({
  ...
  const handleSubmit = async (e) => {
    ...
    if (response?.status == 200 || response?.status == 201) {
      Swal.fire({
        icon: "success",
        text: "Thankyou for Subscribing to our Newsletter Program",
  ...
  return (
    <div className="col-lg-4 col-md-5 order-md-2 blogSide_bar">
      ...
      <div className="blog-sidebar-categories" data-aos="fade-up">
        ...
        <ul className="sidebar-content">
          ...
          {AllCategoryList?.map((item, i) => (
            <Link
              to={`/${globalLanguage}/blogs/${item.route}`}
              key={item.route}
            >
              <li>
      ...
      <div className="blog-sidebar-post" data-aos="fade-up">
        ...
        {InnerBlogbar ? (
          <div className="sidebar-tags" data-aos="fade-up">
            ...
            <ul>
              <li>
                <Link to={`/${globalLanguage}/blogs`}>Interior</Link>
              </li>
              <li>
                <Link to={`/${globalLanguage}/blogs`}>Painting</Link>
              </li>
              <li>
                <Link to={`/${globalLanguage}/blogs`}>Constraction</Link>
              </li>
              <li>
                <Link to={`/${globalLanguage}/blogs`}>Ingineering</Link>
              </li>
              <li>
                <Link to={`/${globalLanguage}/blogs`}>Consultanty</Link>
              </li>
              <li>
                <Link to={`/${globalLanguage}/blogs`}>Property</Link>
              </li>
              <li>
                <Link to={`/${globalLanguage}/blogs`}>Swimming Pool</Link>
              </li>
              <li>
                <Link to={`/${globalLanguage}/blogs`}>Garden</Link>
              </li>
              <li>
                <Link to={`/${globalLanguage}/blogs`}>Furniture</Link>
              </li>
              <li>
                <Link to={`/${globalLanguage}/blogs`}>Event</Link>
              </li>
            </ul>
          </div>
        ) : null}
      ...
      <div className="get_In_touch" data-aos="fade-up">
        <h3>Get In Touch with Us</h3>
        <p className="mt-3">
          <i class="fas fa-phone-alt mr-1" />
          &nbsp; Call us At: <a href="tel:971559136032"> +971 55 913 6032</a>
        </p>
        <p>
          <i className="fas fa-envelope mr-1" />
          &nbsp; Email us At:{" "}
          <a href="mailto:info@rphuae.ae"> info@rphuae.ae</a>
        </p>
      </div>
      <div className="Social_links" data-aos="fade-up">
        <div className="sideTitle">Follow Us</div>

        <ul className="footer_blog_social mt-2">
          <li>
          ...
          <li>
            <a href="https://www.youtube.com/@rphuae/featured" target="_blank">
              <FaYoutube />
            </a>
          </li>
          <li>
