...
import img1 from "../../img/common/foucs 1.png";
import img2 from "../../img/common/focus 2.png";
import Icon1 from "../../img/card logos/design_icon.png";
import Icon2 from "../../img/card logos/deisgn_icon2.png";
import Icon3 from "../../img/card logos/design_icon3.png";
import "./style.css";
      ...
      <div className="container">
        <div className="row">
          <div className="col-lg-12">
            <div className="site-heading text-lg-center">
